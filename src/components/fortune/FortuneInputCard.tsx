  ...
  return (
    ...
    >
      <div className="shrink-0 text-center" style={{ padding: "2.5vh 2vh 1vh" }}>
        ...
        <p className="text-slate-400" style={{ fontSize: "1.2vh", marginTop: "0.8vh" }}>생년월일과 태어난 시간을 입력하면 오늘의 운세를 알려드립니다.</p>
      </div>
      ...
      <div className="flex-1 overflow-y-auto" style={{ padding: "1.5vh 2.5vh" }}>
        <div className="flex flex-col" style={{ gap: "1.8vh" }}>
          <div className="flex flex-col" style={{ gap: "0.5vh" }}>
            <label className="font-semibold text-slate-300" style={{ fontSize: "1.2vh" }}>성별</label>
            <select value={data.gender} onChange={(e) => update({ gender: e.target.value as any })}
              className={selectBase} style={{ borderColor: "rgba(167,139,250,0.2)", fontSize: "1.3vh" }}
            >
          ...
          <div className="flex flex-col" style={{ gap: "0.5vh" }}>
            <label className="font-semibold text-slate-300" style={{ fontSize: "1.2vh" }}>생년월일</label>
          ...
          <div className="flex flex-col" style={{ gap: "0.5vh" }}>
            <label className="font-semibold text-slate-300" style={{ fontSize: "1.2vh" }}>태어난 시간</label>
      ...
      <div className="shrink-0 flex flex-col" style={{ padding: "1.5vh 2.5vh 2vh", gap: "1vh" }}>
        <button onClick={onSubmit} disabled={!valid}
          ...
          style={{
            ...
            color: valid ? "#e2e8f0" : "#94a3b8", fontSize: "1.5vh",
          }}
